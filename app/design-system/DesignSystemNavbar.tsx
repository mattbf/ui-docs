...
import { MagnifyingGlass, Palette, PuzzlePiece } from "@phosphor-icons/react/dist/ssr";
...
const DesignSystemNavbar = () => {
  ...
  return (
    ...
    >
      <div className="flex flex-row items-center gap-4">Design System</div>
      ...
      <div className="flex flex-row items-center gap-4">
        <div className="cursor-pointer flex flex-row items-center border border-stroke-secondary rounded-md text-sm px-2 py-1 hover:bg-surface-hover text-text-secondary gap-2 transition-colors">
          ...
          Search...
          <div className="ml-4 px-1 text-xs py-0 rounded-md bg-white shadow-sm border-[0.5px] border-stroke-tertiary">⌘K</div>
        </div>
      </div>
    </div>
  );
