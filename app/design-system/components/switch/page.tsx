...
const CheckboxPage = () => (
  <ComponentDocsPageTemplate title="Switch" githubLink={"https://github.com/org/repo-name/blob/develop/src/components/ui/Switch.tsx"} path="/switch">
