...
import { DefaultTabsButton, Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/Tabs";
import { Text } from "@/components/ui/Text";

const TabsPage = () => (
  <ComponentDocsPageTemplate title="Tabs" githubLink={"https://github.com/src/components/ui/Component.tsx"} path="/tabs">
    <div className="p-8 min-h-[750px] flex flex-col items-center justify-start">
      ...
      <Tabs defaultValue="default1" className="min-w-[400px] w-[600px] h-[200px]">
        <TabsList>
        ...
        <TabsContent value="default1" className="py-4 border border-stroke-primary">
          <Text variant="headline" size="2xl">
            Another tab
          </Text>
        </TabsContent>
        <TabsContent value="default2" className="py-4 border border-stroke-primary">
          <Text variant="headline" size="2xl">
        ...
        <TabsContent value="default3" className="py-4 border border-stroke-primary">
          <Text variant="headline" size="2xl">
            So fun!
          </Text>
        </TabsContent>
